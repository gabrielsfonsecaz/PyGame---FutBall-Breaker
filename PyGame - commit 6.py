...
# class Brazil(pygame.sprite.Sprite):
#     def __init__(self, groups, assets):
#         # Construtor da classe mãe (Sprite).
#         pygame.sprite.Sprite.__init__(self)

#         self.image = assets['brazil_img']
#         self.rect = self.image.get_rect()
...
# class Brazil1(pygame.sprite.Sprite):
#     def __init__(self, groups, assets):
#         # Construtor da classe mãe (Sprite).
#         pygame.sprite.Sprite.__init__(self)
...
# class Brazil2(pygame.sprite.Sprite):
#     def __init__(self, groups, assets):
#         # Construtor da classe mãe (Sprite).
#         pygame.sprite.Sprite.__init__(self)
...
while state != DONE:
    ...
    window.blit(assets['brazil_img'], (5, HEIGHT - BRAZIL_HEIGHT - 10))
    window.blit(assets['brazil_img'], (40, HEIGHT - BRAZIL_HEIGHT - 10))
    window.blit(assets['brazil_img'], (75, HEIGHT - BRAZIL_HEIGHT - 10))
