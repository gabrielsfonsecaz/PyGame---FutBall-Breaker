...
background = pygame.image.load('assets/img/quadra.png').convert()
background = pygame.transform.smoothscale(background, (450, 600))
goal_img = pygame.image.load('assets/img/goal.png').convert_alpha()
goal_img = pygame.transform.smoothscale(goal_img, (GOAL_WIDTH, GOAL_HEIGHT))
ball_img = pygame.image.load('assets/img/ball.png').convert_alpha()
ball_img = pygame.transform.smoothscale(ball_img, (BALL_WIDTH, BALL_HEIGHT))
bar_img = pygame.image.load('assets/img/chuteira.png').convert_alpha()
bar_img = pygame.transform.smoothscale(bar_img, (BAR_WIDTH, BAR_HEIGHT))
